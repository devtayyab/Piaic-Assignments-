...
def function3():
    ...
    x=a[(a%7==0) & (a%5==0)]   #wrtie your code here #wrtie your code here
    return x
    """
    Expected Output:
...
def function18():
    ...
    x = students[np.where(students<piaic.size)].size
    return x
